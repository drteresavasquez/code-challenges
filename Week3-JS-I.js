...
console.log(areSameLength('just three words', 'two words'));
...
console.log(greaterThanFifty(8));
// 16
...
console.log(combineNames('Stephen', 'Freeny'));
// 26
...
console.log(getTriangleArea(4, 2));